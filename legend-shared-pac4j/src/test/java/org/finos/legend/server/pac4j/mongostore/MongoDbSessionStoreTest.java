...
public class MongoDbSessionStoreTest
{
    ...
    public void before()
    {
        ...
        store = new MongoDbSessionStore("AES", 100, db.getCollection(SESSION_COLLECTION), ImmutableMap.of(JEEContext.class, JEESessionStore.INSTANCE), testTrustedPackages, "LegendSSOTest");
    }
    ...
    public void testCanStoreSessionWithoutUsingUnderlyingStore()
    {
        ...
        assertEquals("testValue", store.get(requestContext, "testKey").orElse(null)); //should be able to retrieve value
    ...
    public void testForceExpiryOfSessionCookie()
    {
        ...
        assertNull(store.get(requestContext, "testKey").orElse(null));
        Cookie[] secondaryResponseCookies = newResponse.getCookies();
